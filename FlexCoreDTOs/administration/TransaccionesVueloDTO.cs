...
namespace FlexCoreDTOs.administration
{
    public class TransaccionesVueloDTO
    {
        ...
        public TransaccionesVueloDTO(int idTransaccion, String descripcion, DateTime fechaHoraEntrada, DateTime fechaHoraSalida, string estado, int versionAplicacion,
